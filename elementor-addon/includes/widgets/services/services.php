<?php
namespace AEFE_ELEMENTOR\AEFEService;
 ...
 * @since 1.0.0
 */
class AEFE_Service extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Services', 'aefe' );
	}
...
<div class="romana_single_our_service">
                        <div class="our_service_icon">
                            <a href="#"><img src="<?php echo AEFE_URL ?>/assets/img/service_icon1.png" alt=""></a>
                        </div>
                        ...
                        <div class="our_service_text">
                            <p>Duis autem vel eum iriure dolor in hendrer putate velit esse moleste consequ veumd eu feugiat nulla facilisis at vero.</p>
                        </div>
                    </div>
